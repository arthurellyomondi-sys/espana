...
export const rewards: Reward[] = [
  ...
  },
  {
    id: "streak-repair",
    name: "Streak Repair",
    description: "Restore a broken streak back to its previous value",
    emoji: "🔧",
    cost: 200,
    type: "consumable",
    unlocked: false,
  },
  {
    id: "double-xp",
    name: "Double XP",
    description: "Double all XP earned for the next 15 minutes",
    emoji: "⚡",
    cost: 75,
    type: "consumable",
    unlocked: false,
  },
  {
    id: "hearts-refill",
    name: "Hearts Refill",
    description: "Restore all 5 hearts during a lesson",
    emoji: "❤️",
    cost: 50,
    type: "consumable",
    unlocked: false,
