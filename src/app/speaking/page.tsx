...
import { SpeechRecognitionGame } from "@/components/SpeechRecognitionGame";
    ...
    <main className="min-h-screen bg-neutral-950">
      <div className="max-w-2xl mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-8">
          ...
          <h1 className="text-xl font-bold text-white">🎤 Speaking Mode</h1>
          <div />
        </div>
        <p className="text-gray-400 mb-8 text-center">
          Practice your pronunciation! Say the Spanish word and get scored.
        </p>
